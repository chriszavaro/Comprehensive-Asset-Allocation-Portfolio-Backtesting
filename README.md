...
## Additional portfolio comparisons
...
| Portfolio | Allocation | CAGR | Volatility | Max month-end drawdown | Ending $10,000 |
|---|---|---:|---:|---:|---:|
| Diversified core | 40% VTI, 15% VEA, 25% BND, 10% GLD, 5% VNQ, 5% SHY | 8.65% | 9.84% | -20.36% | $24,915 |
| Core + 5% Bitcoin | Core, with VTI reduced to 35% and 5% BTC-USD added | 11.98% | 10.86% | -22.17% | $34,703 |
| Technology heavy | 65% VGT, 20% VTI, 10% BND, 5% SHY | 16.50% | 15.76% | -27.94% | $53,627 |
| Dividend focus | 50% SCHD, 25% VYM, 20% BND, 5% SHY | 8.37% | 11.08% | -16.56% | $24,215 |
| 60/40 benchmark | 60% VTI, 40% BND | 8.65% | 10.18% | -20.66% | $24,899 |
